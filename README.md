# BetterMouse Settings

This repository contains my personal [BetterMouse](https://better-mouse.com/) configuration settings for macOS.
...
- Cursor speed and gain adjustments
- Pan gestures with inertia
- Modifier key combinations (Shift, Ctrl, Cmd) for scrolling
- Scroll inversion options (vertical/horizontal)
- Click threshold settings
- Hotkey assignments
- Button and key locking
...
- Test all mouse buttons and gestures
- Verify scroll behavior meets your expectations
- Adjust cursor speed if needed
- Review hotkey assignments
...
These are personal configuration files shared for reference. Feel free to use and modify as needed.
